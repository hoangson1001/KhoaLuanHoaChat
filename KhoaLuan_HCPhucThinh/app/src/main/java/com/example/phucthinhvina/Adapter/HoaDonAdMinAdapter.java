...
import com.example.phucthinhvina.Presenter.SetOnItemClick;

import com.example.phucthinhvina.Activity.Bill.ContentBillAdMinActivity;
...
public class HoaDonAdMinAdapter extends RecyclerView.Adapter<HoaDonAdMinAdapter.ViewHodler> {
    ...
    public void onBindViewHolder(@NonNull HoaDonAdMinAdapter.ViewHodler holder, int position) {
        ...
        holder.txttongtien.setText("Tổng tiền :"+NumberFormat.getInstance().format(sanPhamModels.getTongtien()) +" VNĐ");
