...
import com.example.phucthinhvina.Activity.Account.SignInActivity;
import com.example.phucthinhvina.Activity.Bill.CartActivity;
import com.example.phucthinhvina.Activity.FragMent.FragMent_Bill;
import com.example.phucthinhvina.Activity.FragMent.FragMent_Home;
import com.example.phucthinhvina.Activity.FragMent.FragMent_ProFile;
import com.example.phucthinhvina.R;
import com.example.phucthinhvina.ThongtinungdungFragment;
...
public class Home2Activity extends AppCompatActivity implements FragMent_Home.FragMent_HomeListener {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) { //ánh xạ view và bắt sự kiện
                switch (item.getItemId()){
                    ...
                    case  R.id.dangnhap:startActivity(new Intent( Home2Activity.this, SignInActivity.class));break;
                    case  R.id.lienhe:startActivity(new Intent( Home2Activity.this, ContactActivity.class));break;
                    case  R.id.your_bill:fm=new FragMent_Bill();break;
                    case  R.id.your_cart:startActivity(new Intent(Home2Activity.this, CartActivity.class));break;
                    case  R.id.your_profile:fm = new FragMent_ProFile();break;
                    case  R.id.signout:FirebaseAuth.getInstance().signOut();startActivity(new Intent(Home2Activity.this,SignInActivity.class));finish();break;
                    case R.id.danhmuc: startActivity(new Intent( Home2Activity.this,ThongKeDanhMucActivity.class));break;
...
//        });
        ...
        findViewById(R.id.search).setOnClickListener(view -> {
            startActivity(new Intent(Home2Activity.this,SearchActivity.class));
        });
    ...
    public void onButtonClick() {
        Intent intent = new Intent(Home2Activity.this,ThongKeDanhMucActivity.class);
