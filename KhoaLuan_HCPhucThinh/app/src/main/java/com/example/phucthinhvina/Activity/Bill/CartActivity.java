package com.example.phucthinhvina.Activity.Bill;
...
import com.example.phucthinhvina.Adapter.GioHangAdapter;
import com.example.phucthinhvina.Model.SanPhamModels;
import com.example.phucthinhvina.Presenter.GioHangPreSenter;
import com.example.phucthinhvina.Presenter.GioHangView;
...
//Dien thong tin đặt hàng
    private void CustomInit(Dialog dialog) {
        ...
        txtamount.setText(NumberFormat.getInstance().format(tongtien) + " VNĐ");
    ...
    private void requestPayment() {
        ...
        eventValue.put("merchantname", "Phúc Thịnh VINA"); //Tên đối tác. được đăng ký tại https://business.momo.vn. VD: Google, Apple, Tiki , CGV Cinemas
        ...
        try {
            ...
            objExtraData.put("site_name", "Thanh Toán Sản phẩm");
            ...
            objExtraData.put("movie_format", "Đồ Sản phẩm");
