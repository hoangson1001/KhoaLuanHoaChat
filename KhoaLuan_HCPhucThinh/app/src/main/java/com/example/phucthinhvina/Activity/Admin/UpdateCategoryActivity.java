...
public class UpdateCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Init();
        if (getIntent() != null && getIntent().hasExtra("CT")) {
            categoryModels = (CategoryModels) getIntent().getSerializableExtra("CT");
        }
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    db.collection("LoaiSP").document(sp.getId()).set(sp).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(UpdateCategoryActivity.this, "Thành công!!!", Toast.LENGTH_SHORT).show();

                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(UpdateCategoryActivity.this, "Thất bại!!!", Toast.LENGTH_SHORT).show();
                        }
                    });
