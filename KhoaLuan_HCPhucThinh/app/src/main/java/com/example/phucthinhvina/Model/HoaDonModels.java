package com.example.phucthinhvina.Model;
...
import com.example.phucthinhvina.Presenter.IHoaDon;
...
//                                        d.getLong("tongtien"),d.getLong("trangthai"));
    ...
    public void HandleReadData(int position) {
        ...
        if (user != null && user.getUid().equals("AFsXMFs9uhgoSwUXRjuUn2Sid4v2")) {
            if (position == 0) {
                // Query for all HoaDon documents
                db.collection("HoaDon")
                        .get()
                ...
                // Query for HoaDon documents with a specific status
            ...
            if (position == 0) {
                // Query for HoaDon documents associated with the current user
                db.collection("HoaDon").whereEqualTo("UID", user.getUid())
                        .get()
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            @Override
                            public void onSuccess(@NonNull QuerySnapshot queryDocumentSnapshots) {
                ...
                // Query for HoaDon documents associated with the current user and a specific status
                db.collection("HoaDon").whereEqualTo("UID", user.getUid()).whereEqualTo("trangthai", position)
                        .get()
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            @Override
                            public void onSuccess(@NonNull QuerySnapshot queryDocumentSnapshots) {
