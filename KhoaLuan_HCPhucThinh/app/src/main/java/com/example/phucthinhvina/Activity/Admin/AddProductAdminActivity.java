package com.example.phucthinhvina.Activity.Admin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("LoaiSP").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(@NonNull QuerySnapshot queryDocumentSnapshots) {
                ...
                ArrayAdapter arrayAdapter = new ArrayAdapter(AddProductAdminActivity.this, android.R.layout.simple_list_item_1, list);
    ...
    private void initView() {
            ...
            try {
                ...
                db.collection("SanPham").add(sp).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(@NonNull DocumentReference documentReference) {
                        Toast.makeText(AddProductAdminActivity.this, "Thành công!!!", Toast.LENGTH_SHORT).show();
                        setResult(RESULT_OK);
                        finish();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddProductAdminActivity.this, "Thất bại!!!", Toast.LENGTH_SHORT).show();
                    }
                });
            } catch (Exception e) {
                e.printStackTrace();
        ...
        btnDel.setOnClickListener(view -> {
            db.collection("SanPham").document(sanPhamModels.getId()).delete().addOnSuccessListener(unused -> {
                Toast.makeText(AddProductAdminActivity.this, "Xoá sản phẩm thành công!!!", Toast.LENGTH_SHORT).show();
                setResult(RESULT_OK);
                finish();
            }).addOnFailureListener(e -> {
                Toast.makeText(AddProductAdminActivity.this, "Xoá sản phẩm thất bại!!!", Toast.LENGTH_SHORT).show();
            });
                ...
                db.collection("SanPham").document(sanPhamModels.getId()).set(sp)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(@NonNull Void unused) {
                                Toast.makeText(AddProductAdminActivity.this, "Cập nhật sản phẩm thành công!!!", Toast.LENGTH_SHORT).show();
                                setResult(RESULT_OK);
                                finish();
                            }
                        }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddProductAdminActivity.this, "Cập nhật sản phẩm thất bại!!!", Toast.LENGTH_SHORT).show();
                    }
                });
            } catch (Exception e) {
                e.printStackTrace();
